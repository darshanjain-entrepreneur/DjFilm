    ...
    <div className='w-full flex flex-col items-center mt-8' >
      ...
      <div class="p-2  w-full md:w-1/3 ">
              ...
              <div class="p-2 w-full">
                <button 
                onClick={login}
                class="flex mx-auto text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-pink-600 rounded text-lg">
                  {loading ? <TailSpin height={25} color="white"/> : 'Login'}
                </button>
              </div>
              <div>
                <p>Do not have account? <Link to={"/signup"}><span className='font-bold text-red-600'>Sign Up</span></Link> </p>
              </div>
    </div>
  )
}
